    ...
    <div className="min-h-screen bg-[#11151b] text-slate-100 font-sans">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[11px] text-slate-400 font-mono tracking-wider mt-1">BFMF 2026 · 15-16 AOUT · FERRIERES</div>
            </div>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-5 space-y-4">
          ...
          <section className="bg-[#151b23] rounded-lg ring-1 ring-white/10 p-4">
            ...
            <div className="space-y-1.5">
              {METEO.timeline.map((t, i) => {
                ...
                const st = CODE_METEO[t.code];
                return (
                  <div key={i} className="flex items-center gap-2 text-xs">
                    <span className={`w-1.5 h-1.5 rounded-full ${st.dot} shrink-0`} />
                    <span className="text-slate-300 flex-1 min-w-0 truncate">{t.creneau}</span>
                    <Icon className="w-3 h-3 text-slate-500" />
                    <span className={`font-mono text-[10px] ${st.text} w-12 text-right`}>{st.label}</span>
                  </div>
                );
              })}
            </div>
          ...
          <section className="bg-[#151b23] rounded-lg ring-1 ring-white/10 p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="font-mono text-xs text-slate-400">
                {MEDIA.mentions24h} mentions · {MEDIA.variation >= 0 ? "+" : ""}{MEDIA.variation}%
              </span>
            </div>
            ...
            <div className="text-[10px] text-slate-600 font-mono mt-2">Simule · a connecter a un outil de veille</div>
          </section>
        </div>
        ...
        <section className="bg-[#151b23] rounded-lg ring-1 ring-white/10 p-4">
          ...
          <div className="mt-3 pt-2 border-t border-white/10 flex items-center gap-1.5 text-[11px] font-mono text-slate-500">
            <PhoneCall className="w-3.5 h-3.5" /> Urgence vitale : 112 en priorite, information immediate QG
          </div>
        </section>
