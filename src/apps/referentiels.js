...
{ canal: "PMR4.1", num: 9,  usage: "Coordination générale (QG, scènes, volante)" },
{ canal: "PMR5",   num: 10, numAlt: 5, usage: "Bénévoles parking et sanitaires",
  note: "canal 5 sur les postes parking/sanitaire, canal 10 sur les autres" },
{ canal: "PMR15",  num: 25, usage: "Sécurité privée" },
{ canal: "PMR333", num: 6,  usage: "URGENCE — exclusivement réservé", urgent: true },
];

/* --- Programmation complete des postes radio -------------------------
 Le numero affiche sur le poste ne correspond PAS au numero PMR :
 PMR333 (urgence) se trouve sur le CANAL 6, PMR4.1 sur le CANAL 9.
 Dire "passez sur PMR333" ne suffit pas : donner le numero de canal.

 EXCEPTION : les postes des equipes PARKING et SANITAIRE sont
 programmes differemment -- chez eux, PMR5 est sur le CANAL 5.
-------------------------------------------------------------------- */
...
// Postes programmes differemment (PMR5 sur le canal 5 au lieu du canal 10).
export const RADIO_EXCEPTION = "Postes des équipes PARKING et SANITAIRE : PMR5 est sur le CANAL 5 (et non 10).";
