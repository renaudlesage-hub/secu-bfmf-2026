...
const MOTIFS = [
  "Urgence medicale",
  "Personne blessee / chute",
  "Personne perdue / desorientee",
  "Malaise",
  "Autre urgence",
];
            ...
            <div className="rounded-lg ring-1 ring-white/15 bg-[#1a212b] p-4">
              ...
              {(geoStatus === "refuse" || geoStatus === "indisponible") && (
                <div className="text-[11px] text-amber-300/90">
                  Pas de GPS : decrivez precisement ou vous etes dans le champ ci-dessous (dernier repere passe, cote du chemin...).
                </div>
              )}
            </div>
